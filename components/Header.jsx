    ...
    return (
        <header className='container mx-auto flex items-center py-3 px-8 sm:px-5 text-gray-100 relative z-10 after:border-b after:absolute after:bottom-0 after:inset-x-0'>
            ...
            <div className='ml-auto md:ml-10 lg:ml-20'>
                {theme === 'light' ? (
                    <button type='button' aria-label='Dark Mode' onClick={changeTheme} className='cursor-pointer outline-none'>
                    ...
                    <button type='button' aria-label='Light Mode' onClick={changeTheme} className='cursor-pointer outline-none'>
